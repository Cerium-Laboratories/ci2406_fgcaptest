...
lab=r_row_en_b[9:0]}
N 230 -1600 1110 -1600 {
lab=addr[8:0]
bus=true}
N 840 -1590 840 -1500 {
lab=addr[8:4]}
N 1120 -1590 1120 -1500 {
lab=addr[8:4]}
N 220 -340 250 -340 {
lab=l_vout}
N 980 -640 980 -600 {
...
C {devices/ipin.sym} 230 -1600 0 0 {name=p7 lab=addr[8:0]}
...
C {devices/lab_pin.sym} 900 -1250 0 1 {name=p53 sig_type=std_logic lab=VPWR}
C {devices/lab_pin.sym} 1060 -1250 0 0 {name=p54 sig_type=std_logic lab=VPWR}
C {devices/lab_pin.sym} 1040 -550 0 1 {name=p55 sig_type=std_logic lab=VPWR}
C {devices/lab_pin.sym} 890 -1420 0 1 {name=p56 sig_type=std_logic lab=VPWR}
C {devices/lab_pin.sym} 1070 -1420 0 0 {name=p57 sig_type=std_logic lab=VPWR}
C {devices/lab_pin.sym} 890 -1400 0 1 {name=p58 sig_type=std_logic lab=VGND}
C {devices/lab_pin.sym} 1070 -1400 0 0 {name=p59 sig_type=std_logic lab=VGND}
C {devices/lab_pin.sym} 1180 -1250 0 1 {name=p60 sig_type=std_logic lab=VGND}
C {devices/lab_pin.sym} 780 -1250 0 0 {name=p61 sig_type=std_logic lab=VGND}
...
C {devices/lab_pin.sym} 1280 -820 0 0 {name=p68 sig_type=std_logic lab=VSRC}
C {devices/lab_pin.sym} 1280 -1040 0 0 {name=p69 sig_type=std_logic lab=VSRC}
C {devices/lab_pin.sym} 900 -1230 0 1 {name=p70 sig_type=std_logic lab=vinj}
C {devices/lab_pin.sym} 1060 -1230 0 0 {name=p71 sig_type=std_logic lab=vinj}
...
C {devices/lab_wire.sym} 230 -1600 0 1 {name=p74 sig_type=std_logic lab=addr[8:0]}
C {devices/bus_tap.sym} 1110 -1600 1 0 {name=l13 lab=[8:4]}
C {devices/bus_tap.sym} 970 -1600 1 0 {name=l14 lab=[3:0]}
C {devices/bus_tap.sym} 830 -1600 1 0 {name=l15 lab=[8:4]}
