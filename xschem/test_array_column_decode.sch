...
w;w[15],w[14],w[13],w[12],w[11],w[10],w[9],w[8],w[7],w[6],w[5],w[4],w[3],w[2],w[1],w[0]"
...
C {devices/lab_wire.sym} 570 -400 0 0 {name=p8 sig_type=std_logic lab=a[3:0]}
C {devices/lab_wire.sym} 990 -400 0 1 {name=p9 sig_type=std_logic lab=w[15:0]}
...
tclcommand="
xschem raw_read $netlist_dir/test_array_column_decode.raw tran
"
}
...
.endc
"}
C {devices/parax_cap.sym} 880 -370 0 0 {name=C1[15:0] gnd=0 value=10f m=1}
C {array_column_decode.sym} 730 -400 0 0 {name=x1}
